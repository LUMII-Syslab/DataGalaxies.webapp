...
package lv.lumii.datagalaxies.eemm; 
  	...
  	implements RAAPIReferenceWrapper
{
	...
	{
		// return setSubmitter(lv.lumii.datagalaxies.eemm.Submitter.firstObject(factory));
		long SUBMITTER_ROLE = factory.raapi.findAssociationEnd(factory.COMMAND, "submitter");  
		boolean retVal = factory.raapi.createLink(rObject, lv.lumii.datagalaxies.eemm.Submitter.firstObject(factory).rObject, SUBMITTER_ROLE);

...
class GalaxyEngineMetamodel_RAAPILinkedObjectsList<E extends RAAPIReferenceWrapper> implements List<E> {

	private GalaxyEngineMetamodelFactory factory;
	private long rSourceObject;
	private long rAssociationEnd;
	GalaxyEngineMetamodel_RAAPILinkedObjectsList(GalaxyEngineMetamodelFactory _factory, long _rSourceObject, long _rAssociationEnd)
	{
		factory = _factory;

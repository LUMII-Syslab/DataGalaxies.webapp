  	...
  	implements RAAPIReferenceWrapper
{
	...
	{
		// return setSubmitter(lv.lumii.datagalaxies.mm.Submitter.firstObject(factory));
		long SUBMITTER_ROLE = factory.raapi.findAssociationEnd(factory.COMMAND, "submitter");  
		boolean retVal = factory.raapi.createLink(rObject, lv.lumii.datagalaxies.mm.Submitter.firstObject(factory).rObject, SUBMITTER_ROLE);
		factory.raapi.freeReference(SUBMITTER_ROLE);
		return retVal;
	}

	// package-visibility:
	Command(GalaxyEngineMetamodelFactory _factory)
	{
		factory = _factory;
	...
	public Command(GalaxyEngineMetamodelFactory _factory, long _rObject, boolean _takeReference)
	{
		factory = _factory;
		rObject = _rObject;
	...
	public static Iterable<? extends Command> allObjects(GalaxyEngineMetamodelFactory factory)
	{
	...
	public static Command firstObject(GalaxyEngineMetamodelFactory factory)
	{
		long it = factory.raapi.getIteratorForAllClassObjects(factory.COMMAND);
		if (it == 0)
			return null;
